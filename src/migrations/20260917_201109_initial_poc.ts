...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_role" AS ENUM('marketing', 'admin');
  CREATE TYPE "public"."enum_articles_workflow_status" AS ENUM('draft', 'in-review', 'approved', 'published', 'rejected');
  CREATE TYPE "public"."enum_articles_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__articles_v_version_workflow_status" AS ENUM('draft', 'in-review', 'approved', 'published', 'rejected');
  CREATE TYPE "public"."enum__articles_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__articles_v_published_locale" AS ENUM('es', 'en');
  ...
  CREATE TABLE "users" (
  	...
  	"role" "enum_users_role" DEFAULT 'marketing' NOT NULL,
